...
You will need to install thor (gem install thor), after this you should have all the dependent gems bundled on the project. Next, you run the rots server in the project
